...
```bash
git clone https://github.com/YR-ZR0/bitburner
cd bitburner
npm i
```
...
There are docs for each function where available. Feel free to PR in suggestions
